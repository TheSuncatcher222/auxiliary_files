...
while True:
  ...
  for pic in (
        ...
        eighth, ninth, tenth, eleventh, twelfth, thirtteenth
        ):
      print('\u001b[0m')
      print(pic)
      print('\u001b[27A')
